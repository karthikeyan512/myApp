package com.test.myapp.web.websocket;

import com.test.myapp.security.SecurityUtils;
import com.test.myapp.web.websocket.dto.ActivityDTO;
...
import static com.test.myapp.config.WebsocketConfiguration.IP_ADDRESS;
